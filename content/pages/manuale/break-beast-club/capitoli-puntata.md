...
Disattivare o distruggere il teletrasporto fotonico è considerato un **Conflitto Rango 5** con **Contatore da 4** contrapposto a un . Appena i protagonisti escono dalla sala ricevimenti, il narratore deve far partire due Contatori contrapposti:
un **Contatore da 6** per raggiungere l’antenna contro un **Contatore da 8** che rappresenta l'ira di Gronk il Rigido.
